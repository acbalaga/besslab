...
def _build_hourly_inputs_results_df(
    ...
    data = {
        ...
        "pv_to_contract_mwh": logs.pv_to_contract_mw * cfg.step_hours,
        "bess_to_contract_mwh": logs.bess_to_contract_mw * cfg.step_hours,
        "charge_mwh": logs.charge_mw * cfg.step_hours,
...
def _hourly_inputs_results_column_units() -> Dict[str, str]:
    ...
    return {
        ...
        "expected_mwh": "MWh",
        "delivered_mwh": "MWh",
        "pv_to_contract_mwh": "MWh",
        "bess_to_contract_mwh": "MWh",
        "charge_mwh": "MWh",
        "shortfall_mwh": "MWh",
        "surplus_mwh": "MWh",
        "available_mwh": "MWh",
            ...
            summary_rows.append(
                {
                    ...
                    "PV→Contract MWh": df["pv_to_contract_mwh"].sum(),
                    "BESS→Contract MWh": df["bess_to_contract_mwh"].sum(),
                    "Charge MWh": df["charge_mwh"].sum(),
